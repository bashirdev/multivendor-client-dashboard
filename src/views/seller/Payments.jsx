                ...
                <div className='pt-5 mb-5'>
                    <form>
                        <div className='flex gap-3 flex-wrap'>
                            <input min='0' type="number" className='px-3 py-2 md:w-[65%] focus:border-indigo-200 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#839fd8]' name='amount' />
