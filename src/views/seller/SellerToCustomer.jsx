                ...
                {/* chat sidebar */}
                    ...
                    {/* chat area start */}
                      ...
                      <div className='flex justify-between items-center'>
                        {
                            sellerId &&  <div className="relative flex justify-items-center items-center gap-3">
                                  ...
                                  <div className='w-[10px] h-[10px] bg-green-500 rounded-full absolute right-10 bottom-0'></div>
